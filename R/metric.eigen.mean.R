...
#'
#' @description Calculate the mean eigenvalue centrality of a graph.
#' @param g	The input network.
#' @details \code{metric.eigen.mean} calculates the mean eigenvalue centrality score of graph \emph{g}.
